...
const BUSINESS_INFO = {
  ...
  mapUrl:
    "https://www.google.com/maps/search/?api=1&query=Sandhya+Gems+Corner+New+Barrackpore+Post+Office+Market+Kolkata+700131",
  staticMapUrl:
    "https://maps.googleapis.com/maps/api/staticmap?center=22.6983,88.4371&zoom=16&size=600x300&maptype=roadmap&markers=color:red%7C22.6983,88.4371&key=placeholder",
...
function Header() {
  return (
    <header
      className="fixed top-0 left-0 right-0 z-50 bg-[#1a365d]/95 backdrop-blur-sm border-b border-[#2a4a7a]"
      role="banner"
    >
      <div className="max-w-6xl mx-auto px-4 py-2 flex items-center justify-between gap-4">
        <a
          ...
          aria-label="Sandhya Gems Corner - Home"
        >
        ...
        <Button asChild size="sm">
          <a
            ...
            aria-label="Call our gem expert"
          >
...
function HeroSection() {
  ...
  return (
    <section
      ...
      aria-label="Welcome to Sandhya Gems Corner"
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-t from-[#1a365d] via-[#1a365d]/70 to-[#1a365d]/40"
        aria-hidden="true"
      />
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-sm text-purple-200 mb-4">
          Best Panna, Moonga & Manik stones in Kolkata
        </p>
        ...
        >
          <Button asChild size="lg" className="min-w-[180px]">
            <a
              ...
              aria-label="Call our gem expert at +91 82406-73685"
            >
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="border-white text-white backdrop-blur-sm bg-white/10 min-w-[180px]"
          >
            <a
              href={BUSINESS_INFO.mapUrl}
              target="_blank"
              rel="noopener noreferrer"
              data-testid="button-map-hero"
              aria-label="Get directions to our store on Google Maps"
            >
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
          <div className="flex items-center justify-center sm:justify-start gap-3">
            ...
            <div>
              <span
                className={`inline-block px-2 py-0.5 rounded text-xs font-medium mr-2 ${isOpen ? "bg-green-600 text-white" : "bg-red-600 text-white"}`}
              >
...
function ProductsSection() {
  ...
  return (
    <section
      id="products"
      className="py-12 md:py-16 bg-background scroll-mt-16"
    >
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-center text-muted-foreground mb-8">
          Handpicked gemstones for every occasion
        </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {products.map((product) => {
                ...
                const originalImageUrl =
                  ...
                  "https://placehold.co/400x400/1a365d/d4af37?text=Gemstone";
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#1a365d]/80 to-transparent flex items-end justify-center pb-16">
                <div className="bg-white/95 backdrop-blur-sm rounded-lg px-6 py-4 shadow-lg text-center">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    New Barrackpore Post Office Market, Kolkata - 700131
                  </p>
                </div>
              </div>
                ...
                {BUSINESS_INFO.hours.map((schedule) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`${schedule.isShort ? "text-orange-600 dark:text-orange-400" : "text-muted-foreground"}`}
                      >
                        {schedule.hours}
                        {schedule.isShort && (
...
function TestimonialsSection() {
  const googleReviewsUrl =
    "https://www.google.com/search?q=Sandhya+Gems+Corner+New+Barrackpore+reviews";
    ...
    <section className="py-12 md:py-16 bg-[#1a365d]">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
          ...
          From traditional cuts to rare pieces, find the perfect gemstone for
          every occasion.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="border-white text-white bg-white/10 min-w-[200px]"
          >
            <a
              href={`tel:${BUSINESS_INFO.phone}`}
  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl shadow-2xl max-w-sm w-full p-6 relative">
        ...
        <div className="text-center">
          <div
            className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center mx-auto mb-4"
            aria-hidden="true"
          >
          ...
          <p className="text-gray-600 text-sm mb-6">
            Connect with our gemstone experts on WhatsApp for personalized
            guidance on finding the perfect stone for you.
          </p>
          <Button
...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-0 focus:left-0 focus:z-[100] focus:bg-primary focus:text-primary-foreground focus:p-4"
      >
